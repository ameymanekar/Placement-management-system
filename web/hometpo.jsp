	...
	<div class="heading">
		...
		<div class="container">
			<div class="agile-form">
				<form action="Companyadd.jsp" onsubmit="return myFunction()">
					<ul class="field-list">
						<li class="name">
							<label class="form-label"> Company Name <span class="form-required"> * </span></label>
							<div class="form-input">
								
									<input type="text" pattern="[A-Z a-z]+" name="cname" placeholder="Company Name" required>
								
							</div>
						</li>
						<li> 
							<label class="form-label"> Email contact <span class="form-required"> * </span></label>
							<div class="form-input">
						...
						<li> 
							...
							<div class="form-input">
								<input type="text" name="contactno"  pattern="[1,2,3,4,5,6,7,8,9,0]{10}" title="Input Numbers upto 10 Digits" placeholder="Phone Number" maxlength="10" required >
                                               ...
                                               <li> 
							<label class="form-label"> Website <span class="form-required"> * </span></label>
							<div class="form-input">
								<input type="text" name="website"  placeholder="website" required>
                                                ...
                                                <li> 
							<label class="form-label"> Company Address<span class="form-required"> * </span></label>
							<div class="form-input">
								<textarea type="TEXT" name="caddress" style="width: 98%; height: 80px; background-color: #fff;"   required>
                                                                </textarea>
							</div>
						</li>
                                                ...
                                                <li> 
							<label class="form-label"> Discription <span class="form-required"> * </span></label>
							<div class="form-input">
								<textarea type="text" name="discription" style="width: 98%; height: 130px; background-color: #fff;"   required>
                                                                </textarea>
							</div>
						</li>
