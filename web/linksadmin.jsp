  ...
  text-shadow: 4px 4px 6px rgba(255,255,255,0.46) ;
    ...
    <center>
        ...
        <table cellspacing="20px" width="100%" >
            <tr><td class="mbar" ><a class="mlink" href="homeadmin.jsp" target="f2" >TPO</a></td></tr>
            <tr><td class="mbar" ><a class="mlink" href="departhead.jsp" target="f2" >Department Head</a></td></tr>
            <tr><td class="mbar" ><a class="mlink" href="viewcompany.jsp" target="f2" >VIEW COMPANY</a></td></tr>
            <tr><td class="mbar" ><a class="mlink" href="viewstudent.jsp" target="f2" >VIEW STUDENT</a></td></tr>
            
            
            <tr><td class="mbar" ><a class="mlink" href="selectedstuadmin.jsp" target="f2" >SELECTED STUDENT</a></td></tr>
            
            <tr><td class="mbar" ><a class="mlink" href="admin.jsp" target="_top"  >LOGOUT</a></td></tr>
        </table>
    </center>
    </body>
</html>
