  ...
  text-shadow: 4px 4px 6px rgba(255,255,255,0.46) ;
    ...
    <center>
        ...
        <table cellspacing="20px" width="100%" >
            <tr><td class="mbar" ><a class="mlink" href="hometpo.jsp" target="f2" >COMPANY ADD</a></td></tr>
            <tr><td class="mbar" ><a class="mlink" href="addcriteria.jsp" target="f2" >Add CRITERIA </a></td></tr>
            ...
            <tr><td class="mbar" ><a class="mlink" href="selectedstu.jsp" target="f2" >SELECTED STUDENT</a></td></tr>
              
            <tr><td class="mbar" ><a class="mlink" href="TPO.jsp" target="_top"  >LOGOUT</a></td></tr>
        </table>
    </center>
    </body>
</html>
